            ...
            <div className='mx-[1.6rem]'>
                ...
                <div className={`flex mb-[1.8rem]`}>
                    <div className='w-[200px]'>
                        <img
                            className='w-full object-cover'
                            src='https://static.nike.com/a/images/t_PDP_1728_v1/f_auto,q_auto:eco/df30701f-090c-42b9-9154-d3d62ccfde90/jordan-series-es-shoes-FDtg9v.png'
                            alt=''
                        />
                    </div>
                    <div className='mx-[1.4rem] flex w-full justify-between'>
                        <div>
                            <h3 className={`mb-[0.4rem] ${styles.h3Heading}`}>Jordan Series ES</h3>
                            <p className='mb-[0.4rem]'>Men's Shoes</p>
                            <p className='mb-[0.4rem]'>Black/White/Summit White</p>
                            <div className='flex'>
                                <label htmlFor='' className='me-[5px]'>
                                    Size
                                </label>
                ...
                <div className={`flex mb-[1.8rem]`}>
                    <div className='w-[200px]'>
                        <img
                            className='w-full object-cover'
                            src='https://static.nike.com/a/images/t_PDP_1728_v1/f_auto,q_auto:eco/eed06a38-dc83-4bd6-a4f3-209d70980736/air-jordan-1-zoom-cmft-2-shoes-nX8Qqx.png'
                            alt=''
                        />
                    </div>
                    <div className='mx-[1.4rem] flex w-full justify-between'>
                        <div>
                            <h3 className={`mb-[0.4rem] ${styles.h3Heading}`}>Air Jordan 1 Zoom CMFT 2</h3>
                            <p className='mb-[0.4rem]'>Men's Shoes</p>
                            <p className='mb-[0.4rem]'>Cement Grey/University Blue/White</p>
                            <div className='flex'>
                                <label htmlFor='' className='me-[5px]'>
                                    Size
                                </label>
                ...
                <div className={`flex mb-[1.8rem]`}>
                    <div className='w-[200px]'>
                        <img
                            className='w-full object-cover'
                            src='https://static.nike.com/a/images/t_PDP_1728_v1/f_auto,q_auto:eco/oayhdfynrmutq2bcsmpp/air-max-270-shoes-2V5C4p.png'
                            alt=''
                        />
                    </div>
                    <div className='mx-[1.4rem] flex w-full justify-between'>
                        <div>
                            <h3 className={`mb-[0.4rem] ${styles.h3Heading}`}>Nike Air Max 270</h3>
                            <p className='mb-[0.4rem]'>Men's Shoes</p>
                            <p className='mb-[0.4rem]'>Black/Hot Punch/White/Light Bone</p>
                            <div className='flex'>
                                <label htmlFor='' className='me-[5px]'>
                                    Size
                                </label>
